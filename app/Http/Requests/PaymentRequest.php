...
class PaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'invoice_id' => ['required_without:payable_id', 'nullable', Rule::exists('invoices', 'id')->where('tenant_id', $tenantId)],
            ...
            // Treasury
            'treasury_account_id' => ['nullable', Rule::exists('treasury_accounts', 'id')->where('tenant_id', $tenantId)],
        ];
    }
