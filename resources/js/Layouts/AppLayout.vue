    ...
    <div :dir="direction">
        ...
        <div class="flex h-screen">
            ...
            <aside
                ...
                "
                class="fixed inset-y-0 left-0 z-30 w-64 px-5 py-8 overflow-y-auto transition duration-200 transform bg-white border-r border-gray-100 xl:translate-x-0 xl:relative xl:inset-0 rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-800"
            >
                <div class="flex items-center justify-center mb-8">
                    <Link :href="route('dashboard')" class="flex items-center gap-2 group">
                        <ApplicationLogo class="block w-auto h-10 transition-transform group-hover:scale-110" />
                        <span class="text-xl font-bold tracking-tight text-gray-800 dark:text-white group-hover:text-emerald-600 transition-colors">NamaIn</span>
                    </Link>
                </div>

                <div class="flex flex-col justify-between flex-1">
                    <nav class="-mx-3 space-y-8">
                        <div class="space-y-3">
                            <label
