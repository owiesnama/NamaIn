                ...
                >
                    ...
                    <nav class="space-y-1">
                        ...
                        >
                            ...
                            <NavLink :href="route('pos.invoices')" :active="route().current('pos.invoices')">
                                <svg class="h-4 w-4 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <NavLink :href="route('stock-transfers.index')" :active="route().current('stock-transfers.*')">
                                <svg class="h-4 w-4 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        >
                            ...
                            <NavLink :href="route('storages.index')" :active="route().current('storages.*')">
                                <svg class="h-4 w-4 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <SidebarGroup
                            title="المحاسبة"
                            :active="route().current('sales.*') || route().current('purchases.*') || route().current('payments.*') || route().current('cheques.*') || route().current('expenses.*')"
                        >
                            <template #icon>
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <NavLink :href="route('cheques.index')" :active="route().current('cheques.*')">
                                <svg class="h-4 w-4 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
