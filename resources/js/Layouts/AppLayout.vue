                ...
                <div class="flex flex-1 flex-col overflow-y-auto px-4 py-5">
                    ...
                    <nav class="space-y-1">
                        ...
                        >
                            ...
                            <NavLink v-if="hasFeature('pos') && (can('pos.view') || can('pos.operate'))" :href="route('pos.index')" :active="route().current('pos.index')">
                            ...
                            <NavLink v-if="hasFeature('pos') && can('pos.view')" :href="route('pos.invoices')" :active="route().current('pos.invoices')">
                                <svg class="h-4 w-4 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <NavLink v-if="can('reconciliation.view')" :href="route('reconciliation.index')" :active="route().current('reconciliation.*')">
                            <svg class="h-5 w-5 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                            </svg>
                            <span>{{ __('Reconciliation') }}</span>
                            <span
                                v-if="$page.props.reconciliationOpenCount > 0"
                                class="ms-auto px-2 py-0.5 text-[10px] font-bold rounded-full text-amber-700 bg-amber-100 dark:bg-amber-900/30 dark:text-amber-400"
                            >
                                {{ $page.props.reconciliationOpenCount }}
                            </span>
                        </NavLink>

                        <!-- Devices -->
                        <NavLink v-if="can('devices.view')" :href="route('devices.index')" :active="route().current('devices.*')">
                            <svg class="h-5 w-5 shrink-0 text-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
