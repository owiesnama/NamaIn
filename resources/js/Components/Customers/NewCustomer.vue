...
<template>
    <div>
        <button
            class="w-full px-5 py-2 mt-3 text-sm tracking-wide text-white transition-colors duration-200 rounded-lg sm:mt-0 bg-emerald-500 shrink-0 sm:w-auto hover:bg-emerald-600 dark:hover:bg-emerald-500 dark:bg-emerald-600"
            @click="show = true"
        >
            + Add New Customer
        </button>
