...
<template>
    <div>
        <a
            v-if="props.supplier"
            href="#"
            class="p-2 text-gray-400 transition-all duration-200 rounded-lg hover:text-emerald-600 hover:bg-emerald-50 dark:text-gray-500 dark:hover:text-emerald-400 dark:hover:bg-emerald-900/20 focus:outline-none"
            @click="show = true"
            :title="__('Edit')"
        >
            <svg
        ...
        <button
            v-else
            class="w-full px-5 py-2.5 mt-3 text-sm rtl:text-right tracking-wide text-white transition-colors font-bold duration-200 rounded-lg sm:mt-0 bg-emerald-500 shrink-0 sm:w-auto hover:bg-emerald-600 dark:hover:bg-emerald-500 dark:bg-emerald-600"
            @click="show = true"
        >
            + {{ __("Add New Supplier") }}
        </button>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <h1
                                class="font-semibold text-gray-800 rtl:text-right"
                            >
                                {{ __("Add New Supplier") }}
                            </h1>
                            ...
                            >
                                ...
                                <div class="mt-4">
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="supplier.errors.categories"
                                    />
                                </div>
