                                ...
                                >
                                    ...
                                    <td class="px-8 py-4 text-sm whitespace-nowrap text-end">
                                        <div class="flex items-center justify-end gap-x-2">
                                            <Link :href="route('payments.show', payment.id)" class="p-2 text-gray-400 hover:text-emerald-600 hover:bg-emerald-50 dark:text-gray-500 dark:hover:text-emerald-400 dark:hover:bg-emerald-900/20 rounded-lg transition-all" :title="__('Details')">
