...
<template>
    <AppLayout title="Dashboard">
        ...
        <div class="w-full ">
            <h3 class="text-base font-semibold leading-6 text-gray-800">Last 30 days</h3>

            <dl class="grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-3">
                <div class="relative px-4 pt-5 pb-12 overflow-hidden bg-white sm:px-6 sm:pt-6">
                    <dt>
                        <div class="absolute p-3 rounded-md bg-emerald-500">
                    ...
                    <dd class="flex items-baseline pb-6 ml-16 sm:pb-7">
                        ...
                        <div class="text-sm">
                            <a href="#" class="font-medium text-emerald-600 hover:text-emerald-500"> View all<span class="sr-only"> Total Subscribers stats</span></a>
                        </div>
                        </div>
                    </dd>
                </div>
                ...
                <div class="relative px-4 pt-5 pb-12 overflow-hidden bg-white sm:px-6 sm:pt-6">
                    ...
                    <dd class="flex items-baseline pb-6 ml-16 sm:pb-7">
                        ...
                        <div class="absolute inset-x-0 bottom-0 px-4 py-4 bg-gray-50 sm:px-6">
                        <div class="text-sm">
                            <a href="#" class="font-medium text-emerald-600 hover:text-emerald-500"> View all<span class="sr-only"> Avg. Open Rate stats</span></a>
                        </div>
                        </div>
                    </dd>
                </div>
                ...
                <div class="relative px-4 pt-5 pb-12 overflow-hidden bg-white sm:px-6 sm:pt-6">
                    ...
                    <dd class="flex items-baseline pb-6 ml-16 sm:pb-7">
                        ...
                        <svg class="self-center flex-shrink-0 w-5 h-5 text-red-500" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <div class="absolute inset-x-0 bottom-0 px-4 py-4 bg-gray-50 sm:px-6">
                        <div class="text-sm">
                            <a href="#" class="font-medium text-emerald-600 hover:text-emerald-500"> View all<span class="sr-only"> Avg. Click Rate stats</span></a>
                        </div>
                        </div>
                    </dd>
                </div>
