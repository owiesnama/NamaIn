...
<template>
    <FormSection @submitted="AddNewCategory">
        <template #title>
            Category Managments
        </template>

        <template #description>
            Add, Edit, and Deletes Categories to be used in you Applications.
        </template>
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="flex flex-wrap gap-2 mt-2">
                    <p class="inline-flex items-center px-3 py-2 text-sm font-semibold text-gray-800 bg-gray-200 rounded-lg gap-x-2 ">
                        Watches
