            ...
            <div class="flex flex-col mt-8">
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        <div class="overflow-hidden border border-gray-200 dark:border-gray-700 rounded-xl shadow-none">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    <tr v-for="template in recurring_expenses.data" :key="template.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <button class="focus:outline-none" @click="toggleStatus(template.id)">
                                                <span
:class="[
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap text-right rtl:text-left">
                                            <div class="flex items-center justify-end gap-x-3">
                                                ...
                                                <button class="text-gray-500 hover:text-red-500 transition-colors" @click="deleteTemplate(template.id)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
