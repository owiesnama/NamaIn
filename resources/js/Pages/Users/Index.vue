                    ...
                    <tbody class="divide-y divide-gray-200/60 dark:divide-gray-700/60 bg-white dark:bg-gray-900">
                        <tr v-for="member in paginatedMembers" :key="member.id" class="group hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-200">
                            ...
                            <td v-if="can('users.manage') || can('users.assign-role')" class="px-6 py-4 whitespace-nowrap text-end">
                                <div v-if="member.role !== 'owner'" class="flex items-center justify-end gap-x-1">
                                    <button
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center justify-center p-2.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:text-gray-500 dark:hover:text-blue-400 dark:hover:bg-blue-900/20 rounded-lg transition-all"
                                        :title="__('Resend')"
                                        :aria-label="__('Resend')"
                                    ...
                                    <button
                                        ...
                                        class="inline-flex items-center justify-center p-2.5 text-gray-400 hover:text-red-600 hover:bg-red-50 dark:text-gray-500 dark:hover:text-red-400 dark:hover:bg-red-900/20 rounded-lg transition-all"
                                        :title="__('Remove')"
