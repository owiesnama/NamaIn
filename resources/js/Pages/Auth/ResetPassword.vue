...
<template>
    ...
    <AuthenticationCard :dir="direction">
        ...
        <div class="mb-6 flex flex-col items-center text-center">
            ...
            <h1 class="mt-4 text-2xl font-bold text-slate-900">{{ __('Reset Password') }}</h1>
            <p class="mt-1.5 text-sm text-slate-500">{{ __('Enter your new password below to reset your account access.') }}</p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <!-- New password -->
            <div>
                <label class="mb-2 block text-sm font-medium text-slate-700">{{ __('Password') }}</label>
                <div class="flex overflow-hidden rounded-xl border border-slate-200 bg-slate-100 transition focus-within:border-emerald-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-emerald-100">
                    <div class="flex shrink-0 items-center border-e border-slate-200 bg-slate-100 px-3.5">
                        <svg class="h-4 w-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                    ...
                    <button
                        ...
                        class="flex shrink-0 items-center border-s border-slate-200 bg-slate-100 px-3.5 text-slate-400 transition hover:text-slate-600 focus:outline-none"
                    >
            ...
            <!-- Confirm password -->
            <div>
                <label class="mb-2 block text-sm font-medium text-slate-700">{{ __('Confirm Password') }}</label>
                <div class="flex overflow-hidden rounded-xl border border-slate-200 bg-slate-100 transition focus-within:border-emerald-400 focus-within:bg-white focus-within:ring-2 focus-within:ring-emerald-100">
                    <div class="flex shrink-0 items-center border-e border-slate-200 bg-slate-100 px-3.5">
                        <svg class="h-4 w-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                    ...
                    <button
                        ...
                        class="flex shrink-0 items-center border-s border-slate-200 bg-slate-100 px-3.5 text-slate-400 transition hover:text-slate-600 focus:outline-none"
                    >
                        <svg v-if="!showConfirmPassword" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                        </svg>
                        <svg v-else class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <div class="pt-2">
                ...
                >
                    <span v-if="!form.processing">{{ __('Reset Password') }}</span>
