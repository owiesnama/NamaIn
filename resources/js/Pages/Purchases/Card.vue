<script setup>
    ...
    const emit = defineEmits(['moveToStorage']);
...
<template>
    <div class="bg-white border-2 border-dashed rounded-lg ">
        <div class="p-6 md:flex md:items-center md:justify-between">
            ...
            <div class="flex flex-col gap-4 mt-4 sm:flex-row sm:items-center md:mt-0">
                <button class="flex items-center text-gray-600 transition-colors duration-200 gap-x-2 hover:text-emerald-500">
